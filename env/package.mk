...
export WARDIR=${BASE_PKG_DIR}/war${RELEASELINE}
export MSIDIR=${BASE_PKG_DIR}/windows${RELEASELINE}
export DEBDIR=${BASE_PKG_DIR}/debian${RELEASELINE}/binary
export RPMDIR=${BASE_PKG_DIR}/rpm${RELEASELINE}
